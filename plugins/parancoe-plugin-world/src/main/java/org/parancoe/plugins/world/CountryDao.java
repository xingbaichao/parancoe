...
public interface CountryDao extends GenericDao<Country, String> {
    ...
    List<Country> findByPartialLocalNameAndContinent(String partialLocalName,
            String continent);

    List<Country> findByPartialEnglishName(String partialEnglishName);

    List<Country> findByPartialEnglishNameAndContinent(String partialLocalName,
            String continent);
    ...
    List<Country> findByOrderByEnglishName();
}
