...
package org.parancoe.web.filter;
 ...
 *
 * <p>Variation of the original Spring class, supporting also GET method,
 * in place of only PUT.
 *
...
public class HiddenHttpMethodFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		if (("POST".equals(request.getMethod()) || "GET".equals(request.getMethod())) && StringUtils.hasLength(paramValue)) {
