...
public class JuggerBo {
	...
	public void passwordRecovery(Jugger jugger, String baseUrl)
		...
		// send mail to user
		sendEmail(jugger, baseUrl, "Password Recovery", jugger
				.getChangePasswordCode(), "it/jugpadova/password-recovery.vm");
	}
	...
	private void sendEmail(final Jugger jugger, final String baseUrl,
			final String subject, final String oneWayCode, final String template) {
